      ...
      >
            ...
            >
              ...
              <Box>
                <Typography
                  variant="h4"
                  component="h1"
                  sx={{ fontWeight: 600, fontSize: { xs: '1.5rem', sm: '2rem' }, mb: 0 }}
                >
                  PassagePrep
                </Typography>
                <Typography variant="subtitle1" sx={{ mt: 0, fontSize: { xs: '0.9rem', sm: '1.1rem' } }}>
        ...
        <Box sx={{ flex: 1 }}>
          <Container
            ...
            sx={{
              px: { xs: 2, sm: 3, md: 4 },
              pb: '56px', // Important! Space for fixed footer
            }}
          >
