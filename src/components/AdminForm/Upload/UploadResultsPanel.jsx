const UploadResultsPanel = ({ results, themes }) => {
  ...
  return (
    <div
      className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-4 sm:p-6 w-full max-w-full sm:max-w-2xl mt-6 shadow-md mx-auto break-words"
      role="region"
      aria-labelledby="upload-results-title"
    >
      <h2
        id="upload-results-title"
        className="text-lg sm:text-xl font-semibold text-blue-600 border-b-2 border-blue-600 pb-2 mb-4 break-words"
      >
        Upload Results
      </h2>

      <div className="space-y-1 mb-4" aria-live="polite">
        ...
        <p className="text-green-600 dark:text-green-400 font-medium text-sm sm:text-base break-words">
          Successfully uploaded: {results.successful}
        </p>
        <p className="text-red-600 dark:text-red-400 font-medium text-sm sm:text-base break-words">
      ...
      {results.errors.length > 0 && (
        <div className="mt-4">
          ...
          <div
            className="max-h-56 sm:max-h-72 overflow-y-auto border border-gray-300 dark:border-gray-700 rounded-md p-3 sm:p-4 space-y-3 text-sm sm:text-base break-words whitespace-normal"
            role="list"
          >
