...
const Button = React.forwardRef(({
  ...
  return (
    <button
      ref={ref}
      className={clsx(
        'inline-flex items-center justify-center gap-2 rounded-lg font-semibold transition-all duration-300 focus:outline-none focus-visible:ring-4 focus-visible:ring-offset-2 disabled:cursor-not-allowed',
        'active:scale-[0.97] hover:brightness-110 active:brightness-90',
        variants[variant],
        sizes[size],
        className
      )}
